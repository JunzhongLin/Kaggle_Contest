# Functions for calculate the correlations of variables are defined in this file
# Those function can be passed to pandas.Dataframe.corr to generate the corr matrix
